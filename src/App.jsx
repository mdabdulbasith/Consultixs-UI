    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl text-white space-y-6">
            <p className="text-lg leading-relaxed">
              At <span className="font-semibold text-indigo-300">Consultixs</span>, we specialize in delivering
              next-generation AI solutions that drive <span className="font-medium text-white">efficiency</span>,
              <span className="font-medium text-white"> automation</span>, and intelligent decision-making for modern
              enterprises.
            </p>
            <p className="text-lg leading-relaxed">
              With a dedicated team of AI researchers and engineers, we are committed to helping businesses
              <span className="font-medium text-white"> adapt and grow</span> using the true power of artificial intelligence.
              Whether you're starting or scaling, our solutions are built to evolve with your vision.
            </p>
          </div>
          {/* Our Mission */}
          <div className="max-w-5xl mx-auto mt-16">
            <h3 className="text-2xl font-semibold mb-4 text-center">Our Mission</h3>
            <p className="text-base md:text-lg text-center text-gray-300 max-w-3xl mx-auto">
              Our mission is to bridge the gap between technology and business by delivering AI products that are practical, powerful, and scalable. We aim to empower companies to make data-driven decisions with confidence.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto mt-16">
            ...
            <p className="text-base md:text-lg text-center text-gray-300 max-w-3xl mx-auto">
              Our team consists of experienced data scientists, ML engineers, and business analysts who work collaboratively to develop innovative solutions tailored to your unique challenges.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto mt-16">
            ...
            <ul className="list-disc list-inside text-base md:text-lg text-gray-300 max-w-3xl mx-auto space-y-2">
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-gray-300">
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Healthcare</h4>
                <p className="text-sm">AI-powered diagnostics, patient analytics, and hospital management systems.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Finance</h4>
                <p className="text-sm">Fraud detection, algorithmic trading, and credit risk analysis.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Retail & E-commerce</h4>
                <p className="text-sm">Personalized recommendations, customer analytics, and inventory optimization.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Manufacturing</h4>
                <p className="text-sm">Predictive maintenance, quality inspection, and supply chain automation.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Education</h4>
                <p className="text-sm">Smart content delivery, adaptive learning, and student success prediction.</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-xl p-4">
                <h4 className="font-semibold text-white mb-2">Logistics</h4>
                <p className="text-sm">Route optimization, real-time tracking, and demand forecasting.</p>
              </div>
            </div>
          </div>
          ...
          <section id="contact" className="py-20 bg-gradient-to-b from-black via-black/90 to-black text-white">
            <div className="max-w-3xl mx-auto px-6">
              ...
              <form className="space-y-6 bg-white/10 p-8 rounded-xl border border-white/20 backdrop-blur-sm">
                <div>
